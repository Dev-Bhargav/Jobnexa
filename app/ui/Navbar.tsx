...
export default function Navbar() {
  ...
  return (
    <nav className="w-full pr-4 pl-2 sticky top-0 flex justify-between items-center bg-white">
      <div
        className={cn(
          "w-full py-2 relative flex items-center justify-between after:absolute after:h-[1px] after:left-3 after:right-3 after:bottom-0 after:bg-[#E2E2E1] after:opacity-0 after:transition-opacity duration-200",
          {
