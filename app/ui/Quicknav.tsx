    ...
    <div className="bg-[#FBFBFB] w-max mt-20 border rounded-sm border-[rgb(226,226,225)]">
      <div className="mt-10 w-[630px] flex flex-col items-center">
        ...
        <div className="w-10/12">
          ...
          <div className="mt-3 w-11/12 mx-auto [&_p]:text-[#3E3E3E] [&_p]:leading-5">
            <p>
              SBI Junior Associate Recruitment 2023: 8424 Vacancies -
              Notification Pdf, Apply Online
            </p>
            <div className="w-full my-2 h-[1px] bg-[#E2E2E1]"></div>
            <p>
              NHRC Recruitment 2024, Notification, Apply for 37 Vacancies
              nhrc.nic.in
            </p>
            <div className="w-full my-2 h-[1px] bg-[#E2E2E1]"></div>
            <p>
              SBI Clerk Notification 2024, Apply Online, 8773 Vacancy, Last Date
              10 December 2023
            </p>
          </div>
        </div>
