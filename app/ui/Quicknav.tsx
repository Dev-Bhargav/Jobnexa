...
export default async function Quicknav() {
  ...
  return (
    <div className="w-4/5 max-w-[920px] min-w-[500px] mt-20 border rounded-sm border-[rgb(226,226,225)] bg-[#FBFBFB] ">
      <div className="mt-10 xl:w-[630px] flex flex-col items-center">
        <Newsletter />
